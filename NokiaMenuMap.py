...
match menuChoice:
    case 1:
        ...
        print(phoneBook)
        phoneBookChoice = int(input())
        
        match phoneBookChoice:
            case 1: print("Search")
            case 2: print("Service No. 1")
            ...
            case _: print("Invalid Phone Book option")
    case 2:
        print("Messages")
        messages = """
        ============================================
        ...
        match messageChoice:
            ...
            case _: print("Invalid Messages option")
    case 3: print("Chat")
